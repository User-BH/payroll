...
پاس چهارم عدد تازه‌ای نمی‌سازد؛ فقط مبناهایی را که سه پاس قبل روی آن‌ها حساب
کرده‌اند به‌صورت سطر ثبت می‌کند. پس آخر می‌آید: تا گرد کردن تمام نشده باشد،
آن مبناها هنوز نهایی نیستند.
"""
