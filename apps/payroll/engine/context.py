...
class PayrollContext:
    ...
    def day_ratio(self) -> Decimal:
        ...
        دو روش، چون بین شرکت‌ها فرق می‌کند:

          نسبت ماه   : کارکرد ÷ طول واقعی ماه
          مخرج ثابت ۳۱: کارکرد ۳۰ یا ۳۱ روز → کاملِ ماه، وگرنه کارکرد ÷ ۳۱

        دومی روش فایل ۱۴۰۵ این شرکت است. در ماه‌های ۳۱ روزه این دو فقط روی
        کارکرد ۳۰ روز از هم جدا می‌شوند، ولی در ماه‌های ۳۰ روزه (مهر به بعد)
        روی **هر** کارکرد ناقص فرق می‌کنند — و اختلافشان روی جمعِ مسکن و بن و
        اولاد و تأهل، میلیونی است.

        اینکه در ماهِ ۳۰ روزه هم مخرج ۳۱ بماند، همان چیزی است که فایل شرکت
        می‌کند؛ عجیب به‌نظر می‌رسد و **باید با حسابدار تأیید شود**، ولی
        بازتولیدش وظیفهٔ ماست نه قضاوتش.
        """
