...
STANDARD_ITEMS = [
    ...
    # تأخیر دو ستون روی جدول کارکرد دارد (`late_hours` و `late_minutes`) چون
    # فرمولِ کسر برای ساعت و دقیقه دو مخرجِ متفاوت دارد. `source_field` به
    # ساعت اشاره می‌کند و قالب هر دو ورودی را کنار هم می‌کشد.
    ("LATE", "تأخیر ورود", "HOUR", "late_hours", False, 75, True, True,
