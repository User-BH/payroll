...
«کارکرد قابل پرداخت» محاسبه‌شده است، «مانده مرخصی» از کارتابل می‌آید و
«تأخیر ورود» دو ورودی (ساعت/دقیقه) می‌گیرد. آن‌ها همان‌جا می‌مانند و
بازنویسی‌شان چیزی به کاربر اضافه نمی‌کرد.
